...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        # Можно заменить на простую поверхность
...
state = "menu"
asteroids = pygame.sprite.Group()
asteroid_bullets = pygame.sprite.Group()
score = 0
frame_count = 0
while True:
    ...
    if state == "game":
        ...
        # Появление новых астероидов каждые 10 кадров (пример):
        if frame_count % 10 == 0:
        ...
        hits = pygame.sprite.groupcollide(asteroids, bullets, True, True)
        for hit in hits:
            # Можно добавить взрыв или очки здесь
            pass
